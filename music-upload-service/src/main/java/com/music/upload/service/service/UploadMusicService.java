package com.music.upload.service.service;

import com.music.upload.service.gateway.json.MusicJson;
...
public class UploadMusicService {
    ...
    public void listen(@Payload ConsumerRecord record, @Headers MessageHeaders messageHeaders) throws IOException {
